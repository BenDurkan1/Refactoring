...
public class SearchBySurnameDialog extends JDialog implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
	    ...
	    if (e.getSource() == search) {
	        String surnameToSearch = searchField.getText();
	        this.parent.searchBySurnameField.setText(surnameToSearch);
	        // search Employee by surname with the provided surname
	        this.parent.searchEmployeeBySurname(surnameToSearch);
